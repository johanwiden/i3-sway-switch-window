...
about = {}
with open(os.path.join(here, 'i3_switch_window', '__version__.py')) as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    url='https://github.com/johanwiden/i3-switch-window',
    classifiers=[
    ...
    project_urls = {
        "Bug Tracker": "https://github.com/johanwiden/i3-switch-window/issues"
    },
    license='MIT License',
